...
class DetailNormals:
    ...
    def create_nodes(self) -> None:
        ...
        _ = self.node_tree.links.new(srgb.outputs[2], grimemath.inputs[0])
        _ = self.node_tree.links.new(subtract.outputs[0], grimemath.inputs[1])
        _ = self.node_tree.links.new(srgb.outputs[1], scratchmath.inputs[0])
        _ = self.node_tree.links.new(subtract2.outputs[0], scratchmath.inputs[1])
        _ = self.node_tree.links.new(input.outputs[12], subtract2.inputs[0])
        _ = self.node_tree.links.new(input.outputs[13], subtract.inputs[0])
        _ = self.node_tree.links.new(mix5.outputs[2], mix.inputs[6])
        _ = self.node_tree.links.new(input.outputs[6], mix.inputs[7])
        _ = self.node_tree.links.new(mix.outputs[2], mix2.inputs[6])
        _ = self.node_tree.links.new(input.outputs[7], mix2.inputs[7])
        _ = self.node_tree.links.new(mix2.outputs[2], mix3.inputs[6])
        _ = self.node_tree.links.new(input.outputs[8], mix3.inputs[7])
        _ = self.node_tree.links.new(mix3.outputs[2], mix4.inputs[6])
        _ = self.node_tree.links.new(input.outputs[9], mix4.inputs[7])
        _ = self.node_tree.links.new(mix4.outputs[2], dust.inputs[6])
        _ = self.node_tree.links.new(input.outputs[10], dust.inputs[7])
        _ = self.node_tree.links.new(dust.outputs[2], scratch.inputs[6])
        _ = self.node_tree.links.new(scratchmath.outputs[0], scratch.inputs[0])
        _ = self.node_tree.links.new(scratch.outputs[2], grime.inputs[6])
        _ = self.node_tree.links.new(grimemath.outputs[0], grime.inputs[0])
        _ = self.node_tree.links.new(input.outputs[11], grime.inputs[7])
        _ = self.node_tree.links.new(srgb2.outputs[0], mix5.inputs[0])
        _ = self.node_tree.links.new(srgb2.outputs[1], mix.inputs[0])
        _ = self.node_tree.links.new(srgb2.outputs[2], mix2.inputs[0])
        _ = self.node_tree.links.new(srgb3.outputs[0], mix3.inputs[0])
        _ = self.node_tree.links.new(srgb3.outputs[1], mix4.inputs[0])
        _ = self.node_tree.links.new(input.outputs[4], mix5.inputs[6])
        _ = self.node_tree.links.new(input.outputs[5], mix5.inputs[7])
        _ = self.node_tree.links.new(grime.outputs[2], normalize2.inputs[0])
        _ = self.node_tree.links.new(normalize.outputs[0], normcombine.inputs[1])
        _ = self.node_tree.links.new(normalize2.outputs[0], normcombine.inputs[2])
        _ = self.node_tree.links.new(normcombine.outputs[0], output.inputs[0])
        _ = self.node_tree.links.new(input.outputs[3], normalize.inputs[0])
        _ = self.node_tree.links.new(input.outputs[14], normcombine.inputs[0])
        _ = self.node_tree.links.new(srgb3.outputs[2], dust.inputs[0])
        _ = self.node_tree.links.new(input.outputs[15], normalize.inputs[1])
        _ = self.node_tree.links.new(input.outputs[16], normalize2.inputs[1])
