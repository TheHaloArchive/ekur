...
class Layer:
    ...
    def create_nodes(self) -> None:
        ...
        _ = self.node_tree.links.new(normal.outputs[0], output.inputs[2])
        _ = self.node_tree.links.new(input.outputs[9], reroute10.inputs[0])
        _ = self.node_tree.links.new(input.outputs[10], reroute11.inputs[0])
        _ = self.node_tree.links.new(reroute10.outputs[0], reroute8.inputs[0])
        _ = self.node_tree.links.new(reroute11.outputs[0], reroute7.inputs[0])
        _ = self.node_tree.links.new(input.outputs[8], reroute12.inputs[0])
        _ = self.node_tree.links.new(reroute12.outputs[0], reroute9.inputs[0])
        _ = self.node_tree.links.new(reroute35.outputs[0], gradient.inputs[0])
        _ = self.node_tree.links.new(reroute3.outputs[0], normal.inputs[0])
        _ = self.node_tree.links.new(reroute5.outputs[0], output.inputs[1])
        _ = self.node_tree.links.new(gradient.outputs[0], reroute.inputs[0])
        _ = self.node_tree.links.new(reroute.outputs[0], reroute4.inputs[0])
        _ = self.node_tree.links.new(reroute4.outputs[0], srgb.inputs[0])
        _ = self.node_tree.links.new(srgb.outputs[2], reroute6.inputs[0])
        _ = self.node_tree.links.new(srgb.outputs[0], reroute1.inputs[0])
        _ = self.node_tree.links.new(reroute1.outputs[0], reroute2.inputs[0])
        _ = self.node_tree.links.new(reroute2.outputs[0], output.inputs[0])
        _ = self.node_tree.links.new(reroute6.outputs[0], roughnode.inputs[0])
        _ = self.node_tree.links.new(reroute9.outputs[0], roughnode.inputs[1])
        _ = self.node_tree.links.new(reroute8.outputs[0], roughnode.inputs[2])
        _ = self.node_tree.links.new(reroute7.outputs[0], roughnode.inputs[3])
        _ = self.node_tree.links.new(roughnode.outputs[0], reroute5.inputs[0])
        _ = self.node_tree.links.new(input.outputs[2], uvscaling2.inputs[2])
        _ = self.node_tree.links.new(input.outputs[0], uvscaling2.inputs[0])
        _ = self.node_tree.links.new(uvscaling2.outputs[0], reroute35.inputs[0])
        _ = self.node_tree.links.new(uvscaling.outputs[0], reroute3.inputs[0])
        _ = self.node_tree.links.new(input.outputs[0], uvscaling.inputs[0])
        _ = self.node_tree.links.new(input.outputs[5], uvscaling.inputs[2])
        _ = self.node_tree.links.new(input.outputs[7], uvscaling2.inputs[5])
        _ = self.node_tree.links.new(input.outputs[6], uvscaling2.inputs[4])
        _ = self.node_tree.links.new(input.outputs[1], uvscaling2.inputs[1])
        _ = self.node_tree.links.new(input.outputs[3], uvscaling2.inputs[3])
        _ = self.node_tree.links.new(input.outputs[4], uvscaling.inputs[3])
        _ = self.node_tree.links.new(input.outputs[1], uvscaling.inputs[1])
        _ = self.node_tree.links.new(input.outputs[6], uvscaling.inputs[4])
        _ = self.node_tree.links.new(input.outputs[7], uvscaling.inputs[5])
        _ = self.node_tree.links.new(input2.outputs[12], output.inputs[6])
        _ = self.node_tree.links.new(input2.outputs[13], output.inputs[7])
        _ = self.node_tree.links.new(input2.outputs[14], output.inputs[8])
        _ = self.node_tree.links.new(input2.outputs[15], output.inputs[9])
        _ = self.node_tree.links.new(input2.outputs[16], output.inputs[3])
        _ = self.node_tree.links.new(input2.outputs[17], output.inputs[4])
        _ = self.node_tree.links.new(input2.outputs[11], output.inputs[5])
