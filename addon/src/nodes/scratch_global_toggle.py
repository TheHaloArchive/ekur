...
class ScratchGlobalToggle:
    ...
    def create_nodes(self) -> None:
        ...
        _ = self.node_tree.links.new(zone2.outputs[0], output.inputs[0])
        _ = self.node_tree.links.new(zone3.outputs[0], output.inputs[1])
        _ = self.node_tree.links.new(mix.outputs[0], output.inputs[2])
        _ = self.node_tree.links.new(zone5.outputs[0], output.inputs[3])
        _ = self.node_tree.links.new(zone6.outputs[0], output.inputs[4])
        _ = self.node_tree.links.new(dust.outputs[0], output.inputs[5])
        _ = self.node_tree.links.new(input.outputs[7], zone2.inputs[0])
        _ = self.node_tree.links.new(input.outputs[7], zone3.inputs[0])
        _ = self.node_tree.links.new(input.outputs[7], mix.inputs[0])
        _ = self.node_tree.links.new(input.outputs[7], zone5.inputs[0])
        _ = self.node_tree.links.new(input.outputs[7], zone6.inputs[0])
        _ = self.node_tree.links.new(input.outputs[7], dust.inputs[0])
        _ = self.node_tree.links.new(input.outputs[0], zone2.inputs[3])
        _ = self.node_tree.links.new(input.outputs[0], zone3.inputs[3])
        _ = self.node_tree.links.new(input.outputs[0], mix.inputs[3])
        _ = self.node_tree.links.new(input.outputs[0], zone5.inputs[3])
        _ = self.node_tree.links.new(input.outputs[0], zone6.inputs[3])
        _ = self.node_tree.links.new(input.outputs[0], dust.inputs[3])
        _ = self.node_tree.links.new(input.outputs[1], zone2.inputs[2])
        _ = self.node_tree.links.new(input.outputs[2], zone3.inputs[2])
        _ = self.node_tree.links.new(input.outputs[3], mix.inputs[2])
        _ = self.node_tree.links.new(input.outputs[4], zone5.inputs[2])
        _ = self.node_tree.links.new(input.outputs[5], zone6.inputs[2])
        _ = self.node_tree.links.new(input.outputs[6], dust.inputs[2])
