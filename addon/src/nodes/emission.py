...
class Emission:
    ...
    def create_nodes(self) -> None:
        ...
        _ = self.node_tree.links.new(input.outputs[2], srgb1.inputs[0])
        ...
        _ = self.node_tree.links.new(srgb1.outputs[0], slot5.inputs[0])
        _ = self.node_tree.links.new(srgb1.outputs[1], slot6.inputs[0])
        ...
        _ = self.node_tree.links.new(slot6_1.outputs[2], slot7.inputs[6])
        _ = self.node_tree.links.new(slot6.outputs[2], slot6_1.inputs[6])
        _ = self.node_tree.links.new(input.outputs[10], slot6_1.inputs[7])
        _ = self.node_tree.links.new(subtract.outputs[0], add.inputs[1])
        _ = self.node_tree.links.new(input.outputs[11], subtract.inputs[0])
        _ = self.node_tree.links.new(add.outputs[0], slot6_1.inputs[0])
        _ = self.node_tree.links.new(input.outputs[0], srgb3.inputs[0])
        _ = self.node_tree.links.new(srgb3.outputs[2], add.inputs[0])
        ...
        _ = self.node_tree.links.new(slot6.outputs[0], slot6_1.inputs[2])
        _ = self.node_tree.links.new(input.outputs[10], slot6_1.inputs[3])
        _ = self.node_tree.links.new(slot6_1.outputs[0], slot7.inputs[2])
        _ = self.node_tree.links.new(input.outputs[9], slot7.inputs[3])
        _ = self.node_tree.links.new(slot7.outputs[0], output.inputs[0])
        _ = self.node_tree.links.new(srgb1.outputs[2], slot7.inputs[0])
