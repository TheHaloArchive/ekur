...
class NormalBlend:
    ...
    def create_nodes(self) -> None:
        ...
        _ = links.new(group_input.outputs[2], norm_normalize.inputs[0])
        _ = links.new(group_input.outputs[3], layer_overlay_bool_col_003.inputs[3])
        _ = links.new(group_input.outputs[4], layer_overlay_bool_col_003.inputs[0])
        _ = links.new(group_input.outputs[5], layer_overlay_bool_col.inputs[3])
        _ = links.new(group_input.outputs[6], layer_overlay_bool_col.inputs[0])
        _ = links.new(group_input.outputs[7], layer_overlay_bool_col_001.inputs[3])
        _ = links.new(group_input.outputs[8], layer_overlay_bool_col_001.inputs[0])
        _ = links.new(group_input.outputs[9], layer_overlay_bool_col_002.inputs[3])
        _ = links.new(group_input.outputs[10], layer_overlay_bool_col_002.inputs[0])
        ...
        _ = links.new(layer_overlay_bool_col_002.outputs[0], norm_normalize_001.inputs[0])
        _ = links.new(norm_normalize.outputs[0], normal_map_combine_orientation.inputs[1])
        _ = links.new(norm_normalize_001.outputs[0], normal_map_combine_orientation.inputs[2])
        _ = links.new(normal_map_combine_orientation.outputs[0], normal_map.inputs[1])
        _ = links.new(normal_map.outputs[0], group_output.inputs[0])
