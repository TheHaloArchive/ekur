...
class BetterUVScaling:
    ...
    def create_nodes(self) -> None:
        ...
        _ = self.node_tree.links.new(math_8.outputs[0], subtract.inputs[1])
        _ = self.node_tree.links.new(uvmap.outputs[0], mapping.inputs[0])
        _ = self.node_tree.links.new(combinexyz.outputs[0], mapping.inputs[1])
        _ = self.node_tree.links.new(multiply.outputs[0], math_8.inputs[0])
        _ = self.node_tree.links.new(multiply2.outputs[0], combinexyz2.inputs[0])
        _ = self.node_tree.links.new(multiply.outputs[0], combinexyz2.inputs[1])
        _ = self.node_tree.links.new(combinexyz2.outputs[0], mapping.inputs[3])
        _ = self.node_tree.links.new(subtract.outputs[0], add.inputs[1])
        _ = self.node_tree.links.new(compare.outputs[0], mix.inputs[0])
        _ = self.node_tree.links.new(subtract2.outputs[0], mix.inputs[6])
        _ = self.node_tree.links.new(mix.outputs[2], mix2.inputs[6])
        _ = self.node_tree.links.new(compare2.outputs[0], mix2.inputs[0])
        _ = self.node_tree.links.new(add.outputs[0], combinexyz.inputs[1])
        _ = self.node_tree.links.new(input.outputs[0], multiply2.inputs[0])
        _ = self.node_tree.links.new(input.outputs[4], combinexyz.inputs[0])
        _ = self.node_tree.links.new(input.outputs[5], subtract2.inputs[1])
        _ = self.node_tree.links.new(input.outputs[5], compare.inputs[0])
        _ = self.node_tree.links.new(input.outputs[5], compare2.inputs[0])
        _ = self.node_tree.links.new(mapping.outputs[0], output.inputs[0])
        _ = self.node_tree.links.new(input.outputs[5], mix.inputs[7])
        _ = self.node_tree.links.new(subtract2.outputs[0], mix.inputs[2])
        _ = self.node_tree.links.new(input.outputs[5], mix.inputs[3])
        _ = self.node_tree.links.new(mix.outputs[0], mix2.inputs[2])
        _ = self.node_tree.links.new(input.outputs[5], mix2.inputs[3])
        _ = self.node_tree.links.new(mix2.outputs[0], add.inputs[0])
        _ = self.node_tree.links.new(input.outputs[2], multiply2.inputs[1])
        _ = self.node_tree.links.new(input.outputs[3], multiply.inputs[1])
        _ = self.node_tree.links.new(input.outputs[1], multiply.inputs[0])
