...
use crate::{
    ...
    layered::{
        layered_level::{
            ...
            handle_rohg_1_rohm_2_nnhg_1_mm, handle_rohg_2_alpha_alt, handle_rohg_2_rohm_1_mm_cone,
            ...
            handle_rohm_1_rohg_1_nnhg_1, handle_rohm_1_rohg_2_nnhg_1, handle_rohm_1_rohg_3_mm,
            handle_rohm_1_rohg_3_mm_alt, handle_rohm_2_nnhg_2_color, handle_rohm_2_nnhg_2_mm,
            handle_rohm_2_pack_2_mm, handle_rohm_2_rohg_1_alpha_mm,
            ...
            handle_rohm_3_nnhg_1_color, handle_rohm_3_rohg_1_mm, handle_rohm_3_rohg_1_mm_cone,
        },
...
pub fn process_material(material_tag: &MaterialTag) -> Result<Material> {
    ...
    match material_tag.material_shader.global_id {
        ...
        -338864971 => handle_rohg_1_rohm_2_mm_color(post_process, &mut material)?,
        -1674484151 => handle_rohg_2_rohm_1_mm_cone(post_process, &mut material)?,
        -1300928187 => handle_rohg_1_rohm_1_mm_cone(post_process, &mut material)?,
        -1322925105 => handle_rohm_1_mm_cone_alpha(post_process, &mut material)?,
        337507735 | -2067383589 => handle_rohg_2_rohm_2_mm(post_process, &mut material)?,
        121237379 => handle_rohm_1_cone(post_process, &mut material)?,
        915229326 => handle_rohm_2_rohg_1_mm_cone_norm(post_process, &mut material)?,
        ...
        513702545 => handle_rohg_2_alpha_alt(post_process, &mut material)?,
        1941810293 => handle_rohm_2_nnhg_2_color(post_process, &mut material)?,
        1072858306 => handle_rohm_1_rohg_3_mm(post_process, &mut material)?,
        -420180489 => handle_rohm_3_rohg_1_mm(post_process, &mut material)?,
        -899153114 => handle_rohm_2_rohg_1_alpha_mm(post_process, &mut material)?,
        1425254988 => handle_rohm_1_rohg_3_mm_alt(post_process, &mut material)?,
        540729820 => handle_rohm_3_nnhg_1_color(post_process, &mut material)?,
        _ => {}
    };
