...
use anyhow::Result;
use ekur_definitions::material::{
    MaterialParameter, MaterialStyleShaderSupportedLayers, MaterialStyleShaderSupportsDamageEnum,
    MaterialTag, MaterialTagCampaign,
};

use crate::{Material, ShaderType, StyleInfo, TextureType};
...
pub(crate) fn add_style_info(mat: &MaterialTag, material: &mut Material) -> Result<()> {
...
pub(crate) fn add_style_info_campaign(
