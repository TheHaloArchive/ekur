...
use crate::{DiffuseInfo, Material, ShaderType, TextureType};
use ekur_definitions::material::MaterialPostProcessing;

pub(crate) fn handle_diffuse_shader(
...
pub(crate) fn handle_diffuse_decal_shader(
    post_process: &MaterialPostProcessing,
    material: &mut Material,
) -> Result<()> {
    let mut diffuse_info = DiffuseInfo::default();
...
pub(crate) fn handle_diffuse_decal_notint_shader(
    post_process: &MaterialPostProcessing,
    material: &mut Material,
) -> Result<()> {
    let mut diffuse_info = DiffuseInfo::default();
...
pub(crate) fn handle_diffuse_billboard_shader(
    post_process: &MaterialPostProcessing,
    material: &mut Material,
) -> Result<()> {
    let mut diffuse_info = DiffuseInfo::default();
...
pub(crate) fn handle_diffuse_emissive_shader(
    post_process: &MaterialPostProcessing,
    material: &mut Material,
) -> Result<()> {
    let mut diffuse_info = DiffuseInfo::default();
...
pub(crate) fn handle_diffuse_si_shader(
    post_process: &MaterialPostProcessing,
    material: &mut Material,
) -> Result<()> {
    let mut diffuse_info = DiffuseInfo::default();
...
pub(crate) fn handle_diffuse_si_shader_norough(
    post_process: &MaterialPostProcessing,
    material: &mut Material,
) -> Result<()> {
    let mut diffuse_info = DiffuseInfo::default();
