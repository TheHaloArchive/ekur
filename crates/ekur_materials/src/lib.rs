...
pub enum LevelType {
    ...
    RohmAlpha,
    RohgRohgAlphaAlt,
    RohmRohmNnhgNnhgMMColor,
    RohmRohgRohgRohgMM,
    RohmRohmRohmRohgMM,
    RohmRohgRohmMMAlpha,
    RohmRohgRohgRohgMMAlt,
    RohmRohmRohmNnhgMMColor,
    RohgRohgRohgRohgMMAlt,
    RohgRohmRohgRohmMM,
    RohmRohmRohgRohgMM,
}
...
impl RohgLayer {
    ...
    pub fn read_bounce_layer1_delta_alt(
        ...
        let data = Self {
            ...
            metallic: f32_from_const(material, offset + 72)?,
            top_color: [
                f32_from_const(material, offset + 76)?,
                f32_from_const(material, offset + 80)?,
                f32_from_const(material, offset + 84)?,
